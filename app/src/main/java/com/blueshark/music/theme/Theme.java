...
//    }
    ...
    public static MaterialDialog.Builder getBaseDialog(Context context) {
        return new MaterialDialog.Builder(context)
                ...
                .backgroundColor(Color.parseColor("#17181A"))
                .itemsColorRes(R.color.white)
                .widgetColor(ThemeStore.getAccentColor());
    }

    public static AlertDialog.Builder getBaseAlertDialog(Context context){
        return new AlertDialog.Builder(context);
    }

    public static MaterialDialog.Builder getCustomDialog(Context context) {
        return new MaterialDialog.Builder(context)
                //.contentColorAttr(R.attr.text_color_primary)
                .titleGravity(GravityEnum.CENTER)
                .titleColorRes(R.color.white)
