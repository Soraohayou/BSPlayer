package com.blueshark.music.appshortcuts.shortcuttype
...
import com.blueshark.music.appshortcuts.AppShortcutActivity
...
abstract class BaseShortcutType constructor(val context: Context) {
  ...
  companion object {
    val ID_PREFIX = "com.com.blueshark.music.appshortcuts.id."
