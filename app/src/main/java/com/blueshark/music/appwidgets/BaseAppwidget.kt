package com.blueshark.music.appwidgets
...
import com.blueshark.music.service.MusicService.Companion.EXTRA_CONTROL
...
//    get() = if (skin == WHITE_1F) R.drawable.album_empty_bg_night else R.drawable.album_empty_bg_day
  ...
  protected fun buildAction(context: Context, views: RemoteViews) {
    ...
    val action = Intent(context, launchmain::class.java)
