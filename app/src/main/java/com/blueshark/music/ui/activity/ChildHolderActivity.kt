...
import com.blueshark.music.databinding.ActivityChildHolderBinding
...
import com.blueshark.music.ui.adapter.ChildHolderAdapter
...
import com.blueshark.music.util.MediaStoreUtil.getSongsByArtistIdOrAlbumId
...
//    }
  ...
  companion object {
    ...
    fun start(context: Context, type: Int, key: String?, title: String?, model: BSPlayerModel? = null) {
