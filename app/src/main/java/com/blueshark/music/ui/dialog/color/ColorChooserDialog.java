package com.blueshark.music.ui.dialog.color;
...
public class ColorChooserDialog extends DialogFragment implements View.OnClickListener, View.OnLongClickListener {
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean("in_custom", mColorChooserCustomFrame != null && mColorChooserCustomFrame.getVisibility() == View.VISIBLE);
    }
...
//                MDTintHelper.setTint(mCustomSeekB, selectedColor);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final Builder builder = getBuilder();
        MaterialDialog.Builder bd = com.blueshark.music.theme.Theme.getBaseDialog(getActivity())
                .title(getTitle())
                .autoDismiss(false)
