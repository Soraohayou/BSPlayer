...
import com.blueshark.music.lyric.LyricSearcher
import com.blueshark.music.misc.handler.MsgHandler
import com.blueshark.music.misc.handler.OnHandleMessage
import com.blueshark.music.misc.interfaces.OnInflateFinishListener
...
class LyricFragment : BaseMusicFragment(), View.OnClickListener {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    if (themeRes == R.style.Theme_BSPlayer_Black || themeRes == R.style.Theme_BSPlayer_Dark) {
