...
import com.blueshark.music.misc.menu.AudioPopupListener
...
//  }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arrayOf(binding.layoutPlayerMenus.playbarModel, binding.layoutPlayerMenus.playbarPlayinglist, binding.topActionbar.topHide, binding.layoutPlayerMenus.topMore, binding.layoutPlayerMenus.equalizer, binding.layoutPlayerMenus.speed, binding.layoutPlayerMenus.favorite).forEach {
    ...
    private val onOtherClick = View.OnClickListener { v ->
        when (v.id) {
            ...
            R.id.playbar_playinglist -> newInstance().show(supportFragmentManager, PlayQueueDialog::class.java.simpleName)
...
//        }
            ...
            R.id.equalizer -> {
                ...
                startActivity(Intent(this@PlayerActivity, SoundEffectActivity::class.java))
            }
            R.id.favorite -> {
            ...
            R.id.speed -> {
                Theme.getBaseDialog(this).title(R.string.speed).input(SPUtil.getValue(this, SPUtil.SETTING_KEY.NAME, SPUtil.SETTING_KEY.SPEED, "1.0"), "", MaterialDialog.InputCallback { dialog, input ->
                            var speed = 0f
                            try {
                            ...
                            SPUtil.putValue(this, SPUtil.SETTING_KEY.NAME, SPUtil.SETTING_KEY.SPEED, input.toString())
    ...
    private fun setUpIndicator() {
        ...
        indicators.add(findViewById(R.id.guide_03))
...
//                }
    ...
    private fun updateTopStatus(song: Song?) {
        ...
        //speed.setText(SPUtil.getValue(this, SPUtil.SETTING_KEY.NAME, SPUtil.SETTING_KEY.SPEED, "1.0"))
        ...
        top_title.setOnClickListener({
            startActivity(Intent(this@PlayerActivity, LyricActivity::class.java))
        })
    ...
    private fun setUpFragments() {
        ...
        if (this.isPortraitOrientation()) {
            ...
            view_pager.addOnPageChangeListener(object : OnPageChangeListener {
                ...
                override fun onPageSelected(position: Int) {
                    ...
                    //歌词界面常亮
                    if (position == 1 && SPUtil.getValue(this@PlayerActivity, SETTING_KEY.NAME, SETTING_KEY.SCREEN_ALWAYS_ON, false)) {
        ...
        //歌词界面常亮
        if (SPUtil.getValue(this, SETTING_KEY.NAME, SETTING_KEY.SCREEN_ALWAYS_ON, false)) {
            window.addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON)
        }
    }
    ...
    private fun touchOnCoverFragment(event: MotionEvent): Boolean {
        val rect = Rect()
        return (this.isPortraitOrientation() && view_pager.currentItem == 0) || (binding.containerCover?.getLocalVisibleRect(rect) == true && rect.contains(event.x.toInt(), event.y.toInt()))
    }
...
//        }
    ...
    private fun setUpBottom() {
        bottomConfig = SPUtil.getValue(this, SETTING_KEY.NAME, SETTING_KEY.BOTTOM_OF_NOW_PLAYING_SCREEN, BOTTOM_SHOW_NONE)
...
//        }
        ...
        //播放模式与播放队列
        val playMode = SPUtil.getValue(this, SETTING_KEY.NAME, SETTING_KEY.PLAY_MODEL, Constants.MODE_LOOP)
...
//    next_song.setTextColor(ThemeStore.playerNextSongTextColor)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_SELECT_LYRIC && resultCode == Activity.RESULT_OK) {
            data?.data?.let { uri ->
                SPUtil.putValue(this, SPUtil.LYRIC_KEY.NAME, song.id.toString(), SPUtil.LYRIC_KEY.LYRIC_MANUAL)
