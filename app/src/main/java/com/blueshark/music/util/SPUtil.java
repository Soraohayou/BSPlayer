...
import com.blueshark.music.bean.misc.LyricPriority;
...
public class SPUtil {
  ...
  public static int getValue(Context context, String name, Object key, int dft) {
    Log.d("TAG", "getValue() called with: context = [" + context + "], name = [" + name + "], key = [" + key + "], dft = [" + dft + "]");
    SharedPreferences sharedPreferences = context.getSharedPreferences(name, Context.MODE_PRIVATE);
    int a =  sharedPreferences.getInt(key.toString(), dft);
