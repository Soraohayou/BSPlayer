...
extern "C"
JNIEXPORT void JNICALL Java_com_blushark_music_ui_blur_NativeBlurProcess_functionToBlur(JNIEnv* env, jclass clzz, jobject bitmapOut, jint radius, jint threadCount, jint threadIndex, jint round) {
